  ...
  return (<>
    ...
    <div className="signin-inner">
      ...
      <button type="submit">Sign In</button>
            ...
            value={name}
            onChange={(e) => handleInputChange(e, 'name')}  placeholder='Name'/>
                    </Form.Group>
                    <Form.Group className="mb-3 input-field" controlId="formGroupText">
                      <Form.Control type="text"
            value={username}
            onChange={(e) => handleInputChange(e, 'username')} placeholder="User Name" />
                    </Form.Group>
                    <Form.Group className="mb-3 input-field" controlId="formGroupPassword">
            ...
            value={number}
            onChange={(e) => handleInputChange(e, 'number')} placeholder='Phone No' />
                    </Form.Group>
