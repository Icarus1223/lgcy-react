                                    ...
                                    <div className="chat-box">
                                        <div className="chat user-chat">
                                            <div className="chat-message">
                                                <p>
                                                    Hey. This is a demo of the tex. This is the demo of the text. This
                                                    is the demo of the text. This is the demo of the text
                                                </p>
                                            </div>
                                        ...
                                        <div className="chat another-user-chat">
                                            <div className="chat-message">
                                                <p>Hey. This is a demo of the text.</p>
                                            </div>
                                            <div className="chat-time">
                                                <span>9:25 AM</span>
                                            </div>
                                        ...
                                        <div className="chat user-chat">
                                            <div className="chat-message">
                                                <p>This is the demo of the text. This is the demo of the text</p>
                                            </div>
                                            <div className="chat-time">
                                                <span>9:25 AM</span>
                                            </div>
                                        ...
                                        <div className="chat user-chat">
                                            <div className="chat-message">
                                                <p>Hey This is the demo of the text</p>
                                            </div>
                                            <div className="chat-time">
                                                <span>9:25 AM</span>
                                            </div>
                                        ...
                                        <div className="chat another-user-chat">
                                            <div className="chat-message">
                                                <p>
                                                    This is the demo of the text. This is the demo of the text. This is
                                        ...
                                        <div className="chat user-chat">
                                            <div className="chat-message">
                                                <p>Hey. This is a demo of the text. This is the demo of the text</p>
                                            </div>
                                            <div className="chat-time">
                                                <span>9:25 AM</span>
                                            </div>
